...
#### Effects/Predictions ####
lp <- list.files("Data/Models/Predictions_without_MID/", full.names = TRUE)
...
li <- list.files("Data/Models/Partitioning_without_MID/", full.names = TRUE)
...
cm_l <- list.files("Data/Models/Candidate_models_without_MID/", pattern = ".RDS",
