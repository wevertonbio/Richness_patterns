...
dir.create("Data/Models/Partitioning_without_MID")
dir.create("Data/Models/Predictions_without_MID")
dir.create("Data/Models/Best_models_without_MID")
...
pblapply(cm_l, function(i){
  ...
  #Save results
  saveRDS(data_pm,
            paste0("Data/Models/Predictions_without_MID/", lf_i,".RDS"))
  saveRDS(var_imp,
            paste0("Data/Models/Partitioning_without_MID/", lf_i,".RDS"))
  saveRDS(m_i,
          paste0("Data/Models/Best_models_without_MID/", lf_i, ".RDS"))
